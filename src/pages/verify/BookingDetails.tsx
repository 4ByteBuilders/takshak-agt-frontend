...
export default function BookingDetails({ booking, onCheckInSuccess }: BookingDetailsProps) {
    ...
    return (
        <div className="mt-6 p-6 bg-gray-800 rounded-lg">
            ...
            <p>
                <span className="font-semibold">People Left to Check In:</span> {peopleLeft}
            </p>
            ...
            {peopleLeft > 0 && (
                <div className="mt-4">
                    <p className="font-semibold mb-2">Select number of people to check in:</p>
