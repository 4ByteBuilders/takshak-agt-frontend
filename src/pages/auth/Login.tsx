      ...
      >
        ...
        >
          ...
          <Dialog>
            ...
            <DialogContent>
              <p>
                You're being redirected for Google login. The URL you will see (pmrtrqvcxmiohtugktgj.supabase.co) is an internal service we use for authentication. You can safely log in using your Google account.</p>
              <Button onClick={() => {
                handleGoogleLogin();
              }}>OK</Button>
            </DialogContent>
