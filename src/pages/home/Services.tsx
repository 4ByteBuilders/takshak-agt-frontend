  ...
  return (
    <div className="overflow-hidden py-16">
      ...
      >
        ...
        >
          <img src={img_src} alt="food" className="h-1/3" />
...
const food: [string, string, number, number, string][] = [
  [
    ...
    340,
    10,
    "Splash into vibrant hues and paint the town with joy!",
  ],
  [
    "DJ & EDM",
    "/dj-edm.avif",
    20,
    40,
    "Get ready to groove with electrifying beats all day long.",
  ],
  [
    "Free Welcome Soft Drinks",
    "/soft-drink.avif",
    60,
    90,
    "Quench your thirst with refreshing welcome drinks.",
  ],
  [
    "Dynamic Rain Dance",
    "/rain-dance.avif",
    80,
    120,
    "Dance under a thrilling rain setup with exciting music.",
  ],
  [
    "Bhangra",
    "/bhangra.avif",
    260,
    290,
    "Enjoy energetic Punjabi beats with lively Bhangra moves.",
  ],
  [
    "Food & Beverages",
    "/food.avif",
    290,
    320,
    "Delight in a variety of delicious treats and beverages.",
  ],
];
