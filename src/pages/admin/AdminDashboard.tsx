  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen p-6 mt-12">
      ...
      <div className="flex flex-col gap-6 w-full max-w-2xl">
        <button
          onClick={() => (window.location.href = `${adminUrl}/add-verifiers`)}
        ...
        <button
          onClick={() => (window.location.href = `${adminUrl}/view-messages`)}
        ...
        <button
          onClick={() => (window.location.href = `${adminUrl}/view-concerns`)}
