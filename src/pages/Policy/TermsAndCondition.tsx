...
const TermsAndCondition = () => {
    ...
    return (
        <div className="container mx-20 w-fit p-4">
            ...
            <p className="mb-4">
                Welcome to Takshak! These Terms and Conditions ("Terms") govern your access to and use of our website (https://takshakagt.in/) and any related services provided by Takshak. By using our website and services, you agree to be bound by these Terms. If you do not agree, please refrain from using our services.
            </p>
...
const sections = [
    {
        ...
        content: [
            'Takshak is a company based in Agartala, Tripura, India.',
            'Our services include [briefly mention products/services offered].',
    ...
    },
    {
        ...
        content: [
            ...
            'We accept payments through [mention accepted payment methods].',
    ...
    },
    {
        ...
        content: [
            ...
            'If you wish to request a refund, please contact us at [email/contact info].',
            'Refunds will be processed as per the payment provider’s policies and may take a few business days to reflect in your account.'
        ]
    },
    {
        title: '6. Shipping and Delivery',
        content: [
            'If applicable, shipping times and costs will be displayed at checkout.',
            'We are not responsible for delays caused by external factors such as courier services or customs.'
        ]
    },
    {
